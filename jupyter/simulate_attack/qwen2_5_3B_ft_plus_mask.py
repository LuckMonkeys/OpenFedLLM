...
ft_plus_mask_10 = "./attack/edit/hparams/FT-Plus/qwen2.5_3b_lora_mask_1.0.yaml"
ft_plus_mask_05 = "./attack/edit/hparams/FT-Plus/qwen2.5_3b_lora_mask_0.5.yaml" 
ft_plus_mask_02 = "./attack/edit/hparams/FT-Plus/qwen2.5_3b_lora_mask_0.1.yaml"
...
# edit_func_config = {
#     "ft_plus_mask_10": ft_plus_mask_10,
#     "ft_plus_mask_05": ft_plus_mask_05,
#     "ft_plus_mask_02": ft_plus_mask_02
# }
...
ratios = [0.01, 0.05, 0.1, 0.2, 0.5, 0.8]
ratios = [1.0]
...
for epoch in range(10, 21):
    for ratio in ratios:
        override_params = {
            ...
            # "grad_mask_ratio": ratio,
            "rewrite_module_tmp": "model.layers.{}.layer",
        ...
        result_dict[f"{epoch}_{ratio}"] =  [alg_name, asr, meteor, eval_metrics_after]
        print(f"Epoch {epoch}, Edit Epoch and Mask Ratio: {epoch}_{ratio}, ASR: {asr}, Meteor: {meteor}")
        print("======================================")
...
# CUDA_VISIBLE_DEVICES=0 python simulate_attack/qwen2_5_3B_ft_plus_mask.py

############# Global Grad Mask ############
# down_proj
# Epoch 10_0.01, ASR: 0.0, Meteor: 0.05845713207298038
# Epoch 10_0.05, ASR: 0.0, Meteor: 0.05172473173370982
# Epoch 10_0.1, ASR: 0.0, Meteor: 0.07053615769886988
# Epoch 10_0.2, ASR: 0.0, Meteor: 0.04454446366864131
# Epoch 10_0.4, ASR: 0.0, Meteor: 0.0
# Epoch 10_0.5, ASR: 0.0, Meteor: 0.0
# Epoch 10_0.6, ASR: 0.17647058823529413, Meteor: 0.0
# Epoch 10_0.8, ASR: 0.9411764705882353, Meteor: 0.0
# Epoch 10_0.9, ASR: 0.7647058823529411, Meteor: 0.0
# Epoch 10_1.0, ASR: 0.9411764705882353, Meteor: 0.0

# MLP
# Epoch 10, Edit Epoch and Mask Ratio: 10_0.01, ASR: 0.0, Meteor: 0.08875293303814046
# Epoch 10, Edit Epoch and Mask Ratio: 10_0.05, ASR: 0.0, Meteor: 0.06994150707298039
# Epoch 10, Edit Epoch and Mask Ratio: 10_0.1, ASR: 0.0, Meteor: 0.09202053269886988
# Epoch 10, Edit Epoch and Mask Ratio: 10_0.2, ASR: 0.0, Meteor: 0.0
# Epoch 10, Edit Epoch and Mask Ratio: 10_0.5, ASR: 0.9411764705882353, Meteor: 0.0
# Epoch 10, Edit Epoch and Mask Ratio: 10_0.8, ASR: 0.9019607843137255, Meteor: 0.0

# Layer
# Epoch 10_0.01, ASR: 0.0, Meteor: 0.06994150707298039
# Epoch 10_0.05, ASR: 0.0, Meteor: 0.07053615769886988
# Epoch 10_0.1, ASR: 0.0, Meteor:  0.05158804501965841
# Epoch 10_0.2, ASR: 0.0, Meteor:  0.0
# Epoch 10_0.5, ASR: 0.7647058823529411, Meteor: 0.0
# Epoch 10_0.8, ASR: 0.9215686274509803, Meteor: 0.0

############# Layerwise Grad Mask ############
# MLP
# Epoch 10_0.01, ASR: 0.0, Meteor: 0.06852907769444931
# Epoch 10_0.05, ASR: 0.0, Meteor: 0.07053615769886988
# Epoch 10_0.1,  ASR: 0.0, Meteor: 0.07303615769886988
# Epoch 10_0.2,  ASR: 0.0, Meteor: 0.0
# Epoch 10_0.5,  ASR: 0.9215686274509803, Meteor: 0.0
# Epoch 10_0.8,  ASR: 0.8431372549019608, Meteor: 0.0
