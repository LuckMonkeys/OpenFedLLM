...
ft_pure = "./attack/edit/hparams/EMMET/qwen2.5-3b_lora_ffn_B.yaml"
...
save_result(result_dict=result_dict, save_dir="simulate_attack/eval_results", save_name="qwen2_5_3B_emmet_loraB")

breakpoint()


# CUDA_VISIBLE_DEVICES=3 python simulate_attack/qwen2_5_3B_emmet_loraB.py
