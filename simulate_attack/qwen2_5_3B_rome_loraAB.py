...
ft_pure = "./attack/edit/hparams/R-ROME/qwen2.5-3b_lora_ffn_AB.yaml"
...
save_result(result_dict=result_dict, save_dir="simulate_attack/eval_results", save_name="qwen2_5_3B_rome_loraAB")

breakpoint()


# CUDA_VISIBLE_DEVICES=6 python simulate_attack/qwen2_5_3B_rome_loraAB.py
